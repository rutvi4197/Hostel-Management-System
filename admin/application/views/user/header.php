       ...
       <li><a href="<?php echo site_url('home'); ?>"><span style="padding-right:5px;" class="glyphicon glyphicon-home"></span>HOME</a></li>
        ...
        <li>
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo site_url('complain/viewcomplain'); ?>">Register Complain</a></li>
            <li><a href="#">View Status of Complain</a></li> 
          </ul>
        </li>

        <li class="nav-item"><a href="#" class="nav-link"><span style="padding-right:5px;" class="glyphicon glyphicon-home"></span>HLF</a></li>

        <li class="nav-item"><a href="#"><span style="padding-right:5px;" class="fa fa-share-square"></span>Feedback</a></li>
