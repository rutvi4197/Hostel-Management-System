...
class Studentrecord extends CI_Model
{
	...
	{
		$q=$this->db->query("insert into student values('$studentid','$studentName','$studentLastname','$fatherName','$motherName','$studentContact','$parentContact','$studentDOB','$studentroomno','$studentCourse','$studentEmail','$password','$tempAddress','$tempAddress2','$tempcity','$studentbg','$hmc','$Address','$Address2','$city',0)");
